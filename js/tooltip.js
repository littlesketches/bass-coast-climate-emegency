/* A package of libraries for prototype toolti[s */

/* Anime.js | 2017 Julian Garnier | Released under the MIT license */
...
function configureTooltips(){
		...
		smaug: {
			in: {
				...
				trigger: {
					...
					color: [
						{value: tipTriggerColour, duration: 1, delay: 130, easing: 'easeOutQuad'}
					]
				}
			},
			out: {
				...
				trigger: {
					...
					color: [
						{value: tipTriggerColour, duration: 1, delay: 200, easing: 'easeOutQuad'}
					]
				}
			}
		},
		...
		walda: {
			in: {
				...
				trigger: {
					...
					color: [
						{value: tipTriggerColour, duration: 1, delay: 100, easing: 'easeOutQuad'}
					]
				}
			},
			out: {
		...
		narvi: {
			in: {
				...
				trigger: {
					...
					color: [
						{value: tipTriggerColour, duration: 1, delay: 100, easing: 'easeOutQuint'}
					]
				}
			},
			out: {
				...
				trigger: {
					...
					color: [
						{value: tipTriggerColour, duration: 1, delay: 200, easing: 'easeOutQuint'}
					]
				}
			}
		},
	...
	class Tooltip {
		constructor(el) {
			...
			this.DOM.base = document.querySelector('#'+el.id+'-base');			
